{
  ...
  in
  {
    ...
    home.file.".config/waybar/hyprland.jsonc".source = config.templateFile "waybar-hyprland-json" ./hyprland.jsonc.tmpl settings;
    ...
    home.file.".config/waybar/niri.jsonc".source = config.templateFile "waybar-niri-json" ./niri.jsonc.tmpl settings;
  };
}
